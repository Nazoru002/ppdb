...
@section('title')
    SMK AB | Rekayasa Perangkat Lunak
@endsection
...
@section('first-content')
    <div class="jumbotron">
        <div class="row">
            <div class="col-md-6">
                <h3 class="text-primary">Rekayasa Perangkat Lunak</h3>
                <br>
                <p>Lama Belajar 3 Tahun</p>
                <p style="text-decoration: underline">Pembelajaran Kejuruan :</p>
                <ul style="list-style: none;">
                    <li>1. Komputer dan Jaringan Dasar</li>
                    <li>2. Pemrograman Dasar</li>
                    <li>3. Dasar Desain Grafis</li>
                    <li>4. Pemodelan Perangkat Lunak</li>
                    <li>5. Basis Data</li>
                    <li>6. Pemrograman Berorientasi Obyek</li>
                    <li>7. Pemrograman Web dan Perangkat Bergerak</li>
                    <li>8. Produk Kreatif dan Kewirausahaan</li>
                </ul>
            </div>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{ asset('') }}dist/img/assets/rpl.png" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('') }}dist/img/assets/1.jpeg" alt="Second slide">
                                    {{-- <img class="d-block w-100" src="{{ asset('') }}dist/img/assets/1.1.png" alt="Second slide"> --}}
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('') }}dist/img/assets/ss.png" alt="Third slide">
                                </div>
                            </div>
